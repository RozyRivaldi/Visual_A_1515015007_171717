...
public class formdatabuku extends javax.swing.JFrame {
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        // TODO add your handling code here:
        //Memanggil method validasi dengan nilai parameter diambil dari tiga variabel diatas 
        if(jdl.getText().equals("") && hrg.getText().equals(""))
     {
           JOptionPane.showMessageDialog(null, "Data Belum Lengkap","Kesalahan!",JOptionPane.INFORMATION_MESSAGE);
           jdl.requestFocus();
     } else{
    ...
    private void crActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_crActionPerformed
        // TODO add your handling code here:fc
        //Memanggil method yang kemudian akan menampilkan hasil pencarian
    ...
    private void kmbActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kmbActionPerformed
        // TODO add your handling code here:
        //Berfungsi menampilkan kembali data yang hilang di jtable pada saat proses pencarian (kembali dari proses pencarian)
        InitTable();
        TampilData();
